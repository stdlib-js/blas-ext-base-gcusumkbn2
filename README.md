...
```javascript
gcusumkbn2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcusumkbn2@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcusumkbn2@v0.2.2-umd/browser.js"></script>
```
